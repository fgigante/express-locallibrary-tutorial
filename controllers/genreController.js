...
exports.genre_create_post =  [
    ...
    body('name', 'Genre name cannot be empty').isLength({ min: 1 }).trim(),
...
exports.genre_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (results.genre_books.length > 0) {
            // Genre has no related books. Render in same way as for GET route.
            res.render('genre_delete', { title: 'Delete Genre', genre: results.genre, genre_books: results.genre_books } );
            return;
        }
        else {
            // Genre has no related books. Delete object and redirect to the list of genres.
...
exports.genre_update_post = [
    ...
    // Validate fields.
    body('name', 'Name of genre must not be empty.').isLength({ min: 1 }).trim(),
